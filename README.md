...
- **Interface web admin** : connexion, dashboard, carte interactive, résidents, factures, règlements, impayés. ✅
- **Front portail locataire** : page /portail — lien magique, solde, paiement en ligne, documents. ✅
